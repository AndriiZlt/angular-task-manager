...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(router, route, formBuilder, loginService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          this.registerForm = this.formBuilder.group({
            name: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(/^[A-z0-9]*$/), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(3)]],
            email: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].email, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/)]],
            password: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern(/^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{8,})/), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(8)]]
          });
        }
      }, {
        key: "f",
        ...
        value: function onSubmit() {
          ...
          var capitalized = this.registerForm.value.name.charAt(0).toUpperCase() + this.registerForm.value.name.slice(1);
        ...
        key: "passwordShowHide",
        value: function passwordShowHide() {
    ...
    LoginComponent.ɵfac = function LoginComponent_Factory(t) {
      return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_login_service__WEBPACK_IMPORTED_MODULE_3__["LoginService"]));
    };
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 21,
      vars: 20,
      consts: [[1, "container"], [1, "screen"], [3, "formGroup", "ngSubmit"], [1, "form-field"], ["type", "text", "placeholder", "Name", "required", "", "formControlName", "name", "id", "nameInput", 1, "form-control", 3, "ngClass", "ngModelChange"], ["class", "invalid-feedback", 4, "ngIf"], ["type", "email", "placeholder", "Email", "required", "", "formControlName", "email", 1, "form-control", 3, "ngClass", "ngModelChange"], ["id", "passwordDiv", 1, "form-field"], ["placeholder", "Password", "id", "password", "required", "", "formControlName", "password", 1, "form-control", 3, "type", "ngClass", "ngModelChange"], [1, "eye", 3, "click"], ["alt", "eye", 3, "src"], ["class", "invalid", 4, "ngIf"], [1, "loginBtn", 3, "disabled"], ["width", "34", "height", "34", "viewBox", "0 0 74 74", "fill", "none"], ["cx", "37", "cy", "37", "r", "35.5", "stroke", "black", "stroke-width", "3"], ["d", "M25 35.5C24.1716 35.5 23.5 36.1716 23.5 37C23.5 37.8284 24.1716 38.5 25 38.5V35.5ZM49.0607 38.0607C49.6464 37.4749 49.6464 36.5251 49.0607 35.9393L39.5147 26.3934C38.9289 25.8076 37.9792 25.8076 37.3934 26.3934C36.8076 26.9792 36.8076 27.9289 37.3934 28.5147L45.8787 37L37.3934 45.4853C36.8076 46.0711 36.8076 47.0208 37.3934 47.6066C37.9792 48.1924 38.9289 48.1924 39.5147 47.6066L49.0607 38.0607ZM25 38.5L48 38.5V35.5L25 35.5V38.5Z", "fill", "black"], [1, "invalid-feedback"], [4, "ngIf"], [1, "invalid"]],
      template: function LoginComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginComponent_Template_input_ngModelChange_4_listener() {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginComponent_Template_input_ngModelChange_7_listener() {
            return ctx.onFormChange();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function LoginComponent_Template_input_ngModelChange_10_listener() {
            return ctx.onFormChange();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_div_click_11_listener() {
            return ctx.passwordShowHide();
          });
